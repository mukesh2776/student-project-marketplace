    ...
    useEffect(() => {
        ...
        const fetchProject = async () => {
            try {
                ...
                // Check ownership
                const sellerId = project.seller?._id || project.seller;
            ...
            <div className="min-h-screen flex items-center justify-center py-12">
                <div className="text-center glass-card p-8 max-w-md">
                    ...
                    <p className="text-gray-400 mb-6">
                        You need to be a seller to edit projects.
                    </p>
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <p className="text-gray-500">
                                            {formData.downloadFile
                                                ? 'Click to replace project ZIP file'
                                                : 'Click to upload project ZIP file'}
                                        </p>
                                        <p className="text-gray-500 text-sm">ZIP files only (Max 100MB)</p>
                                        {formData.downloadFile && (
                                            <p className="text-green-600 text-xs mt-1">✓ A project file is already uploaded</p>
                                        )}
                                    </div>
                                )}
                            </div>
